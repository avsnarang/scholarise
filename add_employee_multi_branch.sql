-- Add middleName column to Employee table if it doesn't exist
DO $$
BEGIN
    IF NOT EXISTS (
        SELECT 1
...
-- Remove isMultiBranchAccess column if it exists
DO $$
BEGIN
    IF EXISTS (
        SELECT 1
        ...
        ALTER TABLE "Employee" DROP COLUMN "isMultiBranchAccess";
    END IF;
END
$$; 
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input {...field} placeholder="Professional qualifications or certifications" />
              </FormControl>
              <FormDescription>Relevant professional certifications and qualifications</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input {...field} placeholder="Special certifications" />
              </FormControl>
              <FormDescription>Industry-specific or specialized certifications</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input {...field} placeholder="e.g., Finance, HR, Operations" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}

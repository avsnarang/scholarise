...
export function SiblingDetailsTab() {
  ...
  return (
    <div className="space-y-6 p-6">
      <h3 className="text-xl font-medium text-[#00501B]">Sibling Details</h3>
      ...
      <div className="space-y-6">
        <div className="flex items-end gap-4">
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex-1">
                <FormLabel>Sibling's Admission Number</FormLabel>
                <FormControl>
                  <Input {...field} placeholder="Enter sibling's admission number" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <Button
            ...
            className="mb-[2px] bg-[#00501B] hover:bg-[#00501B]/90 gap-2"
          >
            {isSearching ? (
              <>

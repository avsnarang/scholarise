  ...
  const cards: CategoryCard[] = [
    {
      ...
      href: "/staff/teachers",
      actions: {
        primary: { label: "View All Teachers", href: "/staff/teachers" },
        secondary: { label: "Add Teacher", href: "/staff/teachers/create" },
      },
      stats: teacherStats,
    },
    {
      ...
      actions: {
        primary: { label: "View All Employees", href: "/staff/employees" },
        secondary: { label: "Add Employee", href: "/staff/employees/create" },
      },
      stats: employeeStats,
    },
    {

...
const departmentGroups = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/staff/departments/structure",
        roles: ["admin", "superadmin"],
        disabled: true,
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/staff/departments/performance",
        roles: ["admin", "superadmin"],
        disabled: true,
      },
      {
        ...
        href: "/staff/departments/resources",
        roles: ["admin", "superadmin"],
        disabled: true,
      },
    ],
    ...
    items: [
      {
        ...
        href: "/staff/departments/settings",
        roles: ["admin", "superadmin"],
      },
      {
        ...
        href: "/staff/departments/academic",
        roles: ["admin", "superadmin"],
      },
    ],
  },

...
function EditStudentPageContent() {
  ...
  const formattedData = {
    ...
    classId: student.section?.id || "", // Changed from sectionId to classId to match form schema
    ...
    fatherAadharNumber: student.parent?.fatherAadharNumber || "",
    ...
    motherAadharNumber: student.parent?.motherAadharNumber || "",
    ...
    guardianAadharNumber: student.parent?.guardianAadharNumber || "",

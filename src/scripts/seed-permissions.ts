...
const defaultPermissions = [
  ...
  { name: 'override_marked_attendance', description: 'Override already marked attendance', category: 'attendance' },
...
const defaultRoles = [
  ...
  },
  {
    ...
    permissions: [
      ...
      'view_attendance', 'mark_attendance', 'mark_attendance_any_date', 'override_marked_attendance', 'view_attendance_reports',
  ...
  },
  {
    ...
    permissions: [
      ...
      'view_attendance', 'mark_attendance_any_date', 'view_attendance_reports',

...
const AddNewStudentPage: NextPageWithLayout = () => {
  return (
    <PageWrapper
...
AddNewStudentPage.getLayout = (page) => {
  return <AppLayout title="Add New Student" description="Add a new student in ScholaRise ERP">{page}</AppLayout>
}
